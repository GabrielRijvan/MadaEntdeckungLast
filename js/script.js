document.addEventListener("DOMContentLoaded", () => {
  console.log("Mada Entdeckung - Script d'animation initialisé avec succès !");
...
*/
  ...
  // ==========================================================================
  const galleryItems = document.querySelectorAll(".galerie-item img, .fiche-hero-image img");
  ...
  // ==========================================================================
  const activityCards = document.querySelectorAll(".activites-grid .activite-card");
  ...
  console.log("Toutes les animations et interactions de script.js sont prêtes.");
});